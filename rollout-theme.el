...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(company-tooltip ((t (:foreground ,bright-black :background ,yellow))))
   `(company-tooltip-selection ((t (:foreground ,bright-black :background ,cyan))))
   `(company-tooltip-annotation ((t (:foreground ,magenta))))
   `(company-tooltip-annotation-selection ((t (:foreground ,yellow))))
